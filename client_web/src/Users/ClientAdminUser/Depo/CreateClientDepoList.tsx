...
const CreateClientDepo: React.FC = () => {
  ...
  const areRequiredFieldsEmpty = () => {
    return !name || !email || !companyName || !language || !status;
  };
  ...
  return (
    <Box>
      ...
      <Dialog open={open} onClose={handleClose}>
        <DialogTitle sx={{ fontWeight: "800", fontSize: "20px", mt: "10px" }}>{t('Create Client Depo')}</DialogTitle>
        <DialogContent>
        ...
        <DialogActions sx={{ display: 'flex', justifyContent: 'space-between', mx: '15px', mb: '20px' }}>
          <Box>
          ...
          <Box>
            <Button
              ...
              color="primary"
              variant="contained"
              disabled={areRequiredFieldsEmpty() || loading || !!emailError}
...
export default CreateClientDepo;
